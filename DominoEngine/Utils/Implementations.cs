...
public static class Implementations {
    ...
    public static (string, Type)[] GetOutputTypes() {
        ...
        foreach (var item in types) {
            ...
            // var methods = item.GetMethods(BindingFlags.Static | BindingFlags.Public);
            // foreach (var method in methods) {
                
            //     result.Add((item.Name, (Generator<object>)Delegate.CreateDelegate(typeof(Generator<object>), method)));
            // }            
        }
